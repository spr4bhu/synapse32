...
async def load_program(dut, instructions):
    ...
    for i, instr in enumerate(instructions):
        ...
        addr = i * 4
        dut.unified_memory_inst.ram[addr + 0].value = (instr >> 0) & 0xFF
        dut.unified_memory_inst.ram[addr + 1].value = (instr >> 8) & 0xFF
        dut.unified_memory_inst.ram[addr + 2].value = (instr >> 16) & 0xFF
        dut.unified_memory_inst.ram[addr + 3].value = (instr >> 24) & 0xFF
...
def set_data_mem(dut, addr, value):
    ...
    dut.unified_memory_inst.ram[offset].value = value & 0xFF
    dut.unified_memory_inst.ram[offset + 1].value = (value >> 8) & 0xFF
    dut.unified_memory_inst.ram[offset + 2].value = (value >> 16) & 0xFF
    dut.unified_memory_inst.ram[offset + 3].value = (value >> 24) & 0xFF
